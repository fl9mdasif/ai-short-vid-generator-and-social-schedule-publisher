            ...
            <main className="container mx-auto px-4 py-24 md:px-6 max-w-4xl">
                ...
                <div className="prose prose-invert prose-indigo max-w-none space-y-6 text-zinc-300">
                    ...
                    <section>
                        ...
                        <p>
                            Welcome to vidMaxx ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data.
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <a href="mailto:asifalazad.fullstack@gmail.com" className="text-indigo-400 hover:text-indigo-300 ml-1">asifalazad.fullstack@gmail.com</a>
                        </p>
                    </section>
                </div>
            </main>
