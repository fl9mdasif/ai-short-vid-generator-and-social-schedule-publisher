...
export async function POST(request: Request) {
  try {
    ...
    const response = await fetch("https://api.useplunk.com/v1/send", {
      ...
      body: JSON.stringify({
        to: "asifalazadami2021@gmail.com",
        subject: `[VidmaXX] ${subject}`,
        body: `
          <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; line-height: 1.6;">
            <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 10px;"> VidmaXX Contact Form Message</h2>
            ...
            <p style="font-size: 0.8rem; color: #71717a; margin-top: 30px; border-top: 1px solid #e4e4e7; padding-top: 10px;">
              Generated via Plunk API from your VidmaXX contact form.
            </p>
          </div>
        `,
      }),
